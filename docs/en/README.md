...
- [C4 Model](rd/c4/README.md) — system context, containers, components (API server incl. GraphQL feed, web app, mobile app); feed from followed users, multi-media posts
