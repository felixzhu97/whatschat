...
- [C4 模型](rd/c4/README.md) — 系统上下文、容器、组件（图见 [en/rd/c4](../en/rd/c4/)）
  - [Level 1 系统上下文](../en/rd/c4/system-context.puml) · [Level 2 容器](../en/rd/c4/containers.puml)
  - [Level 3 API 服务组件](../en/rd/c4/components-api-server.puml) · [Level 3 Web 组件](../en/rd/c4/components-web-app.puml) · [Level 3 移动端组件](../en/rd/c4/components-mobile-app.puml) · [Level 3 Admin 组件](../en/rd/c4/components-admin-app.puml)
- [TOGAF](rd/togaf/README.md) — 四大架构域：概览、业务、应用、数据、技术（图见 [en/rd/togaf](../en/rd/togaf/)）
