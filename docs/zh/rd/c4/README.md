...
| 3 | [components-api-server.puml](../../../en/rd/c4/components-api-server.puml) | API：Auth、Users、Messages、Chats、Posts、Feed（关注用户帖子）、Comments、Follow、Search、WebSocket、仓储 |
| 3 | [components-web-app.puml](../../../en/rd/c4/components-web-app.puml) | Web：导航、Feed（真实关注流、多图/视频轮播）、Reels、个人页、发帖（多图/视频）、私信、右侧栏、i18n、Hooks、API/WS |
