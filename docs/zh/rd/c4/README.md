...
| 3 | [components-api-server.puml](./components-api-server.puml) | API：认证、用户、消息、聊天、帖子、信息流（互动排序）、探索、评论、关注（推荐）、搜索、WebSocket、仓储 |
| 3 | [components-web-app.puml](./components-web-app.puml) | Web：导航、信息流（点赞/收藏）、Reels、探索、个人页（粉丝/关注列表无限滚动、isFollowing）、发帖、评论弹窗、私信、右侧栏、i18n、Hooks、API/WS |
